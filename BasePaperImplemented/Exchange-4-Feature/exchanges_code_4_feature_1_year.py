# -*- coding: utf-8 -*-
"""Exchanges-Code_4-Feature_1-Year.ipynb
...
closedf = closedf[(maindf['Date'] > '2021-02-19') & (maindf['Date'] <= '2022-02-19')]
date_column = date_column[(maindf['Date'] > '2021-02-19') & (maindf['Date'] <= '2022-02-19')].reset_index(drop=True)

print("Total data for prediction: ", closedf.shape[0])

# After filtering the data but before deleting the 'Date' column
closedf = maindf[['Date', 'Open', 'High', 'Low', 'Adj Close', 'Volume', 'Close']]
closedf = closedf[(maindf['Date'] > '2021-02-19') & (maindf['Date'] <= '2022-02-19')].reset_index(drop=True)
...
save_path = '/content/drive/MyDrive/Fyp_Model/Exchange-4-feature_Lstm_Model.keras'
